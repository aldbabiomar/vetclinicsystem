"""
Database backups for VetClinicSystem.
...
# Same VETCLINICSYSTEM_DATA_DIR convention attachments.py uses — this
...
def _pg_conn_parts():
    ...
    try:
        ...
        return "vetclinicsystem", "", "vetclinicsystem", "127.0.0.1", "5432"
...
def _pg_restore_toc_count(list_cmd):
    ...
    lines look like "123; 1259 12345 TABLE public visits vetclinicsystem" —
...
def _run_backup_locked(db, dest_dir=None, retention=None, triggered_by=None, on_progress=None):
    ...
    try:
        ...
        probe = os.path.join(dest_dir, ".vetclinicsystem_write_test")
