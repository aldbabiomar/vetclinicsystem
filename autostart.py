"""
"Start VetClinicSystem automatically when this computer starts" — the Settings
...
def managed_data_dir():
    """Returns vetclinicsystem-data/ if this install has been switched onto
    ...
    env_dir = os.environ.get("VETCLINICSYSTEM_DATA_DIR")
    ...
    # under vetclinicsystem-releases/, in which case the sibling data dir
    ...
    candidate = os.path.join(parent, "vetclinicsystem-data")
...
TASK_NAME = "VetClinicSystem Autostart"
...
def _windows_shortcut_path():
    ...
    return os.path.join(d, "VetClinicSystem.bat") if d else None
